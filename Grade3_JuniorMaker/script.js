const grade3Data = [
    { 
        ...
        slides: [
            ...
            { 
                type: "software", 
                text: "认识机器大脑: Bambu Studio", 
                steps: ["打开 [ Bambu Studio ]", "认识 [ 打印盘面 ]", "寻找顶部 [ 缩放与移动 ]", "找到左上角 [ 基础形状 ]"] 
            },
            { 
                type: "printer", 
                text: "认识魔法盒: 拓竹 A1", 
    ...
    { title: "我的名字徽章", tag: "第 2 课", slides: ["我们要有自己的徽章！", "数字画布：制作卡片", "阴阳魔法：镂空与凸起", "骨架探秘：5%与50%填充", "切片见证：神奇的内部"] },
    { title: "积木搭建大师", tag: "第 3 课", slides: ["乐高挑战：搭建城堡", "方块与圆柱：好朋友", "对齐魔法：站稳了吗？", "空间大冒险：旋转视角"] },
    { title: "几何动物园", tag: "第 4 课", slides: ["变个魔术：抠洞洞", "小耳朵猪：怎么变？", "神奇组合：零件与负零件", "多彩世界：给小猪穿彩衣"] },
    { title: "魔法拼图", tag: "第 5 课", slides: ["放不下怎么办：神奇纸带", "切瓜魔法：切割工具", "严丝合缝：添加连接销", "多盘打印：摆放大玩具"] },
    { title: "桌面小管家", tag: "第 6 课", slides: ["给文具找个家", "精确输入：量量你的橡皮", "掏空魔法：用负零件挖空", "专属设计：名字刻字"] },
